...
public class Demo {
	...
	public void logout() throws Exception {
		...
		WebElement ele = driver
				.findElement(By.xpath("//a [@href='https://my.naukri.com/HomePage/view'][@ target='_blank']"));
		Actions act = new Actions(driver);
		Action mouse_move = act.moveToElement(ele).build();
		mouse_move.perform();

		Thread.sleep(5000);
		driver.findElement(By.xpath("//a [@href='https://www.naukri.com/nlogin/logout'] [@title='Logout']")).click();
